	...
	$.fn.pagination = function(options) {
		...
		var init = function() {
			...
			*/
			settings = $.extend({
				...
				wrapElement                    : 'div class="pagination_contents"',
				prevBtnText                    : '&lt;',
				nextBtnText                    : '&gt;',
				firstPageBtnText               : '&lt;&lt;',
				endPageBtnText                 : '&gt;&gt;',
		...
		var createNavigation = function() {
			var $paginationWrap         = $('<' + settings.wrapElement + '>'),
				$paginationBox          = $('<ul class="pagination_content">'),
				$paginationItem         = $('<li class="pagination_list">'),
			...
			if (settings.prevNextPageBtnMode) {
				$prevPageBtnBox = $('<p>');
				$nextPageBtnBox = $('<p>');
				$prevPageBtn    = $('<button class="next_button">').attr('type', 'button');
				$nextPageBtn    = $('<button class="next_button">').attr('type', 'button');
		...
		var changeClassName = function() {
			...
			if (settings.pageLinkMode && settings.currentpageLinkUnWrap) {
				$nextTurrentItem.text($nextTurrentItem.attr('value'));

				var i = $prevCurrentItem.attr('value');
